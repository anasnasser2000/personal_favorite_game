...
@login_required
def categories():
    return render_template("categories.html", mode="favorite")
...
def category(slug):
    categories_data = {
        "single": ("لعب مفرد", "🎮", "اللعب المفرد"),
        "couples": ("مرتبطين", "❤️", "للثنائي المرتبط"),
        "friends": ("أصدقاء", "👥", "لعب الأصدقاء"),
        "siblings": ("إخوة", "🫂", "لعب الإخوة"),
        "engaged": ("مخطوبين", "💍", "للخاطبين"),
        "married": ("متزوجين", "🏠", "للأزواج"),
    }
    ...
    cards = [
        {"number": 1, "name": "الكرت الأول"},
        {"number": 2, "name": "الكرت الثاني"},
        {"number": 3, "name": "الكرت الثالث"},
        {"number": 4, "name": "الكرت الرابع"},
        {"number": 5, "name": "الكرت الخامس"},
    ]
